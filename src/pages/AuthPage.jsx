...
export default function AuthPage({ onSuccess }) {
  ...
  return (
    <div className="auth-page"><div style={{textAlign:'center',padding:'12px',marginBottom:'8px'}}><a href="/" style={{color:'#7A9A7A',fontSize:'14px',textDecoration:'none',fontFamily:'sans-serif'}}>? Back to home</a></div>
