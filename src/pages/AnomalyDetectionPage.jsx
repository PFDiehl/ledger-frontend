  ...
  return (
    <div className="page">
      ...
      <p style={{ fontSize: 13, color: 'var(--color-text-secondary)', marginTop: 4, maxWidth: 720 }}>
        ...
        and big first-time payees. Everything here is a flag to review — nothing is changed.
      </p>
      ...
      {!loading && findings.length === 0 && !data?.note && (
        <div className="card" style={{ padding: 40, marginTop: 20, textAlign: 'center' }}>
          ...
          <p style={{ fontSize: 15, fontWeight: 600, marginBottom: 6 }}>Nothing unusual</p>
      ...
      {!loading && findings.length > 0 && (
        <div style={{ display: 'flex', flexDirection: 'column', gap: 10, marginTop: 6 }}>
          {findings.map((f, i) => {
            ...
            return (
              <div key={f.primaryId + i} className="card" style={{ padding: '14px 16px', borderLeft: `4px solid ${s.dot}`, display: 'flex', gap: 14, alignItems: 'flex-start' }}>
