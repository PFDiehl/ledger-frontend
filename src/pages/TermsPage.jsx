export default function TermsPage() {
  ...
  return (
    <div style={{maxWidth:800,margin:'0 auto',padding:'48px 24px',fontFamily:'sans-serif',color:'#333',lineHeight:1.7}}>
      ...
      <p>These Terms of Service ("Terms") govern your access to and use of Mountain Top Ledger (the "Service"), operated by Mountain Top Ledger ("we," "us," or "our"). By creating an account or using the Service, you agree to these Terms. If you do not agree, do not use the Service.</p>

      <h2 style={H2}>1. The Service</h2>
      <p>Mountain Top Ledger provides online bookkeeping and invoicing tools, including customer and vendor records, invoices, expenses, bills, reporting, and optional integrations with third-party services such as QuickBooks Online and Stripe. We may add, change, or remove features over time.</p>
